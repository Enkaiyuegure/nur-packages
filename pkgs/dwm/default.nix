...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://github.com/Enkaiyuegure/dwm/archive/refs/tags/${version}.tar.gz";
    sha256 = "sha256-MWdnbTViZ2YzbGhsanI4a2hhaXI0OTFocHdzcGN3emRid2I0ajhrYngwbTMxeGI4MXoxNwo=";
  };
